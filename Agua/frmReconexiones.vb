Public Class frmReconexiones
    ...
    Private Sub llenaGrid()
        ...
        str = "sp_listadoReconexion " & fechaSQL(Me.cmbFechaInicio.Text) & "," & fechaSQL(Me.cmbFechaFin.Text) & "," & Me.cmbIdProyecto.SelectedValue
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        frmListadoReconexion.MdiParent = MDIPrincipal
