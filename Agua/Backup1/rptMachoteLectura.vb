...
Public Class rptMachoteLectura
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "agua.rptMachoteLectura.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptMachoteLectura
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptMachoteLectura = New rptMachoteLectura
        rpt.Site = Me.Site
        Return rpt
    End Function
