...
#End Region
    ...
    Private Sub btnAgregarFactura_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAgregarLectura.Click
        ...
        tbl.sqlString = "exec sp_insertaConvenio " & Me.cmbIdContador.SelectedValue & "," & fechaSQL(Me.txtFecha.Text) & "," & mdlPublicVars.idUsuario & ",'" & Me.txtComentario.Text & "'," & Me.txtNoPagos.Text
