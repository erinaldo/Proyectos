...
Public Class rptListadoLecturas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "agua.rptListadoLecturas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptListadoLecturas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptListadoLecturas = New rptListadoLecturas
        rpt.Site = Me.Site
        Return rpt
    End Function
