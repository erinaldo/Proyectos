...
Public Class rptImpresionNotasCobro
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptImpresionNotasCobro.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "agua.rptImpresionNotasCobro.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptImpresionNotasCobro
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptImpresionNotasCobro = New rptImpresionNotasCobro
        rpt.Site = Me.Site
        Return rpt
    End Function
