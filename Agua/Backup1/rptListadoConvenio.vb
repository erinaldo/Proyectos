...
Public Class rptListadoConvenio
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "agua.rptListadoConvenio.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptListadoConvenio
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptListadoConvenio = New rptListadoConvenio
        rpt.Site = Me.Site
        Return rpt
    End Function
