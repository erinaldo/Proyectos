...
Public Class rptListadoOtro
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "agua.rptListadoOtro.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptListadoOtro
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptListadoOtro = New rptListadoOtro
        rpt.Site = Me.Site
        Return rpt
    End Function
