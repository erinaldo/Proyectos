...
Public Class rptContratoAgua
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "agua.rptContratoAgua.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptContratoAgua
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptContratoAgua = New rptContratoAgua()
        rpt.Site = Me.Site
        Return rpt
    End Function
