...
Public Class rptCobroDelDia
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "agua.rptCobroDelDia.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCobroDelDia
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCobroDelDia = New rptCobroDelDia()
        rpt.Site = Me.Site
        Return rpt
    End Function
