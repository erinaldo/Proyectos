...
Public Class rptListadoFactura
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "agua.rptListadoFactura.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptListadoFactura
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptListadoFactura = New rptListadoFactura()
        rpt.Site = Me.Site
        Return rpt
    End Function
