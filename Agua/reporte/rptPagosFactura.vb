...
Public Class rptPagosFactura
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "agua.rptPagosFactura.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPagosFactura
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPagosFactura = New rptPagosFactura()
        rpt.Site = Me.Site
        Return rpt
    End Function
