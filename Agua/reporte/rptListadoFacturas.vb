...
Public Class rptListadoFacturas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "agua.rptListadoFacturas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptListadoFacturas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptListadoFacturas = New rptListadoFacturas()
        rpt.Site = Me.Site
        Return rpt
    End Function
