Public Class frmListadoConvenio
    ...
    Private Sub btnImprimir_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnImprimir.Click
        ...
        str = "exec sp_listadoConvenio " & fechaSQL(Me.txtFechaInicio.Text) & "," & fechaSQL(Me.txtFechaFin.Text) & "," & proyecto

        Dim t As New clsDevuelveTabla
        Dim r As New clsReporte
        r.nombreParametro = "filtro"
        r.parametro = filtro
        r.reporte = "rptListadoConvenio.rpt"
