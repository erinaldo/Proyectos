...
#End Region
    ...
    Private Sub btnAgregarLectura_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAgregarLectura.Click
        ...
        tbl.sqlString = "exec sp_insertaNotaCredito " & fechaSQL(Me.txtFecha.Text) & "," & Me.cmbIdContador.SelectedValue & "," & mdlPublicVars.idUsuario & "," & Me.txtLectura.Text & ",'" & Me.txtObservacion.Text & "'," & Me.cmbTipo.SelectedIndex + 1
        If tbl.ejecutaSQL = 0 Then
            MsgBox("Ocurrio un error al insertar la lectura", MsgBoxStyle.Critical, "!!!")
        End If
        MsgBox("Nota de credito ingresada satisfactoriamente", MsgBoxStyle.Exclamation, "!!!")
