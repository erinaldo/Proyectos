...
' de la tabla 'tblCliente' de la base 'bdagua'
' Fecha: 08/feb/2009 21:37:36
'
...
Public Class clsCliente
    ...
    Private Shared Function row2clsCliente(ByVal r As DataRow) As clsCliente
    ...
    Private Shared Sub clsCliente2Row(ByVal oclsCliente As clsCliente, ByVal r As DataRow)
    ...
    Private Shared Sub nuevoclsCliente(ByVal dt As DataTable, ByVal oclsCliente As clsCliente)
    ...
    End Function
    '
    Public Shared Function Buscar(ByVal sWhere As String) As clsCliente
    ...
    Public Function Actualizar(ByVal sel As String) As String
        ...
        sCommand = "UPDATE tblCliente SET nombre = @nombre, direccion = @direccion, telefono = @telefono, facturarA = @facturarA, nit = @nit, email = @email  WHERE (idCliente = @idCliente)"
    ...
    Public Function Crear() As String
        ...
        '       Yo compruebo que sea un campo llamado idCliente, pero en tu caso puede ser otro
        sCommand = "INSERT INTO tblCliente (nombre, direccion, telefono, facturarA, nit, email)  VALUES(@nombre, @direccion, @telefono, @facturarA, @nit, @email)"
